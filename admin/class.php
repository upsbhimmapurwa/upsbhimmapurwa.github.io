      ...
      <div class="side-navbar-wrapper">
       ...
       <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="class.php"> <i class="fas fa-book-reader"></i>Class  </a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" name="class_id" id="class_id" class="form-control" placeholder="Enter Class ID">
        ...
        <div class="form-group">
          <label>Year</label>
          <input type="text" name="year" id="year" class="form-control" placeholder="Enter New Class">
