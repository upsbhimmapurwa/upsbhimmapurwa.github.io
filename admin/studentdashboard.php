    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img src="../images/head1.jpg" alt="person" class="img-fluid rounded-circle">
            <h2 class="h5"><div class="name"><?php echo $name; ?>    </div></h2><span>Student Dashboard</span>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="#">Show Result</a></li>
          </ul>
        </div>
     </div>
    </nav>
