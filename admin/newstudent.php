      ...
      <div class="side-navbar-wrapper">
       ...
       <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active" ><a href="newstudent.php"> <i class="fas fa-user-tie"></i>New Student  </a></li>
...
<section>
 <div class="container-fluid">
  ...
  <div class="col-sm-4">
    ...
    <input type="text" title="rollno" id="rollno" name="" value='' class="textbox form-control text_upper" >
    </div>
  <div class="col-sm-4">
