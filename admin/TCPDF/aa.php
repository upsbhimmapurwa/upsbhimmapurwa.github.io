...
$pdf->SetHeaderData(PDF_HEADER_LOGO, 100, 'U.P.S.BHIMMAPURWA'.' 048', PDF_HEADER_STRING);
$pdf-> Cell(190,10,"my name is",1,1,'C');
$pdf-> WriteHTMLCell(0,0,'','',"<h3>my name is</h3>",1,1);
