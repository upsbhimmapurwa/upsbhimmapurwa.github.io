...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'img/', K_PATH_MAIN.'img/', 'img/', 'img/', '/img/', '/img/', '/tcpdf/img/', 'G:/localhost/xampp/htdocs/tcpdf/img/', K_PATH_MAIN);
