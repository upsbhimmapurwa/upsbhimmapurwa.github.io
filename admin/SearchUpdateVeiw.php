...
<?php 
 $name=$_POST['name'];
  ...
  if (isset($_POST['submit']) )
   { 
    $name=$_POST['name'];
    $sql=" select * from  student where name ='$name' and srno ='$srno'";
...
<form name='admission' class="zoom-anim-dialog mfp-hide white-popup-block mfp-hide form-horizontal" action="" method=""  enctype="multipart/form-data">
 ...
 -->
<h4 style="background:#1ea0ba;color:#fff; padding:10px 0px 10px 5px; border: solid;">Update Student Data <p style="text-align:right;"><a href="search.php" style="text-align:right; text-decoration: none;color: white;">Back</a></p></h4>
    <div class="middle">
              <div class="left">                                                   
